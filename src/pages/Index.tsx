...
const questions: Question[] = [
  ...
  },
  {
    id: 2,
    category: 'Классическая формула',
    question: 'В фирме такси свободно 20 машин: 10 чёрных, 2 жёлтых и 8 зелёных. По вызову выехала одна из машин, случайно оказавшаяся ближе всего к заказчице. Найдите вероятность того, что к ней приедет зелёное такси.',
    options: ['0.2', '0.3', '0.4', '0.5'],
    correctAnswer: 2,
    explanation: 'Всего машин: 20. Зелёных машин: 8. Вероятность = 8/20 = 0.4'
  },
  {
    id: 3,
  ...
  {
    id: 4,
    category: 'Формула Бернулли',
    question: 'Монету подбрасывают 8 раз. Какова вероятность, что "орёл" выпадет ровно 3 раза?',
    options: ['0.11', '0.22', '0.33', '0.44'],
    correctAnswer: 1,
    explanation: 'По формуле Бернулли: P = C(8,3) × (0.5)³ × (0.5)⁵ = 56 × 0.125 × 0.03125 ≈ 0.22'
  },
  {
    id: 5,
  ...
  },
  {
    id: 6,
    category: 'Условная вероятность',
    question: 'Игральную кость бросили один или несколько раз. Оказалось, что сумма выпавших очков равна 4. Какова вероятность того, что был сделан ровно один бросок?',
    options: ['0.2', '0.25', '0.33', '0.5'],
    correctAnswer: 2,
    explanation: 'Сумма 4 может быть: один бросок (4), два броска (1+3, 2+2, 3+1). Всего 4 исхода, один благоприятный: 1/3 ≈ 0.33'
  },
  {
    id: 7,
    category: 'Классическая формула',
    question: 'В случайном эксперименте бросают две игральные кости. Найдите вероятность того, что в сумме выпадет 8 очков.',
    options: ['5/36', '1/6', '1/9', '7/36'],
    correctAnswer: 0,
    explanation: 'Всего исходов: 6 × 6 = 36. Сумма 8: (2,6), (3,5), (4,4), (5,3), (6,2) = 5 вариантов. P = 5/36'
  },
  {
    id: 8,
    category: 'Комбинаторика',
    question: 'В коробке 15 пирожных: 5 с кремом и 10 с повидлом. Наугад выбирают одно пирожное. Какова вероятность, что оно окажется с кремом?',
    options: ['1/5', '1/3', '2/5', '1/2'],
    correctAnswer: 1,
    explanation: 'Всего пирожных: 15. С кремом: 5. Вероятность = 5/15 = 1/3'
  },
  {
    id: 9,
    category: 'Формула Бернулли',
    question: 'Вероятность попадания в цель при одном выстреле равна 0.7. Произведено 3 выстрела. Какова вероятность ровно двух попаданий?',
    options: ['0.189', '0.343', '0.441', '0.588'],
    correctAnswer: 2,
    explanation: 'P = C(3,2) × (0.7)² × (0.3)¹ = 3 × 0.49 × 0.3 = 0.441'
  },
  {
    id: 10,
    category: 'Условная вероятность',
    question: 'В коробке 9 карандашей: 4 красных и 5 синих. Наугад вынули два карандаша подряд без возвращения. Какова вероятность, что оба карандаша красные?',
    options: ['1/6', '2/9', '1/3', '4/9'],
    correctAnswer: 0,
    explanation: 'P(оба красные) = (4/9) × (3/8) = 12/72 = 1/6'
  },
  {
    id: 11,
    category: 'Классическая формула',
    question: 'В группе туристов 12 человек. Их вертолётом доставляют в лагерь по 3 человека за рейс. Порядок, в котором вертолёт перевозит туристов, случаен. Найдите вероятность того, что турист Иванов полетит первым рейсом.',
    options: ['0.1', '0.2', '0.25', '0.33'],
    correctAnswer: 2,
    explanation: 'В первом рейсе летят 3 из 12 человек. Вероятность = 3/12 = 0.25'
  },
  {
    id: 12,
    category: 'Комбинаторика',
    question: 'На экзамене 40 билетов. Студент знает ответы на 32 из них. Найдите вероятность того, что студенту достанется билет, который он знает.',
    options: ['0.6', '0.7', '0.8', '0.9'],
    correctAnswer: 2,
    explanation: 'Вероятность = 32/40 = 0.8'
  }
];
